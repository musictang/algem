        ...
        implements Cacheable
{
  ...
  public Vector<User> find(String where) throws SQLException {
    Vector<User> v = new Vector<User>();
    String query = "SELECT p.id,p.ptype,p.nom,p.prenom,p.civilite,u.login,u.password,u.profil FROM personne p, " + TABLE + " u ";
    if (where != null) {
