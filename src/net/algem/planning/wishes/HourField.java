        ...
        implements KeyListener
{
  ...
  public Hour get() { //TODO ERIC ERROR voir retour référence sur objet private
    return buf.getHour();
  }
  ...
  public void set(Hour d) { //TODO ERIC voir set null
    if (d != null) {
      buf = new HourDocument(this, d.toString(), extended);
    } else {
        buf = new HourDocument(this, "     ", extended);
    }
    setDocument(buf);
    pos = 0;
