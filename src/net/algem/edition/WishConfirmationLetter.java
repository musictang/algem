/*
 * @(#)WishConfirmationLetter.java 2.17.0 05/04/19
 *
 ...
 */
public class WishConfirmationLetter {
    ...
    public static final int PERIODE_X1 = 290;
    ...
    public WishConfirmationLetter(PageTemplateIO ptio, String periode, Person student, List<EnrolmentWish> wishes) {
    ...
    public String toPDF() throws DocumentException, IOException {
        ...
        String tmpFileName = "lettre-confirmation-" + student.getId() + "_";
        return pdfHandler.createPdf(tmpFileName, outputStream, PageTemplate.WISHCONFIRM_PAGE_MODEL, false); 
    }
