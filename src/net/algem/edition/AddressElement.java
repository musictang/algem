/*
 * @(#)AddressElement.java 2.6.a 17/09/12
 * 
...
public class AddressElement extends DrawableElement
{
  ...
  public void draw(Graphics g) {
    ...
    if (address != null) {
      g.drawString(address.getAdr1(), x, y);
      g.drawString(address.getAdr2(), x, y + lineH);
      g.drawString(address.getCdp() + " " + address.getCity(), x, y + (2 * lineH));
    }
  }
