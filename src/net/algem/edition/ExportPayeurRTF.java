/*
 * @(#)ExportPayeurRTF.java	2.11.0 21/09/16
 *
 * Copyright (c) 2001-2016 Musiques Tangentes. All Rights Reserved.
 *
...
//    this(_path, p.getId(), dc);
        this(_path, p.getMember() == null ? p.getId() : p.getMember().getPayer(), dc);
    }
