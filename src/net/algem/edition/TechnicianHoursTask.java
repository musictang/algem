/*
 * @(#)TechnicianHoursTask.java	2.9.1 03/12/14
 *
...
class TechnicianHoursTask
          extends HoursTask
  {
    ...
    public TechnicianHoursTask(HourEmployeeDlg dlg, ProgressMonitor pm, PrintWriter out, ResultSet rs, boolean detail) {
      super(dlg, pm, detail);
      this.out = out;
      this.rs = rs;
    }
