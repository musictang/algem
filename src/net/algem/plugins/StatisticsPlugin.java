/*
 * @(#)StatisticsPlugin.java	2.10.0 07/06/2016
 *
    ...
    for (Map.Entry<Integer, String> entry : statList.entrySet()) {
      switch (entry.getKey()) {
        ...
        case 8:
          ...
          break;
        case 9:
          printTableIntResult("Nombre d'élèves par instrument pour les cours individuels (Loisir)", super.getQuery("students_by_instrument", false, 0));
          printTableIntResult("Nombre d'élèves par instrument pour les cours individuels (Pro)", super.getQuery("students_by_instrument", true, 0));
          /*if (estabList.size() > 1) {
