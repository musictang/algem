        ...
        extends TableIO
{
  ...
  /**
   * Finds a substitute for a course, estab or specific teacher.
   * Favorite are first displayed in the list (marked by stars).
   * @param dc
   ...
   * @throws SQLException
   */
  public static Vector<SubstituteTeacher> find(int estabId, int course, int teacherId, int day, DataConnection dc) throws SQLException {
    Vector<SubstituteTeacher> vr = new Vector<SubstituteTeacher>();
  ...
  public static Vector<SubstituteTeacher> findAll(DataConnection dc) throws SQLException {
    Vector<SubstituteTeacher> v = new Vector<SubstituteTeacher>();
