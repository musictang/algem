...
public class AgeRangeIO
    ...
    public List<AgeRange> find(String where) throws SQLException {

        List<AgeRange> v = new ArrayList<>();
     ...
     * @deprecated It's preferable to not verify overlapping. We might have for
     * exemple 2 ranges : 10-12 et 8-15.
     */
