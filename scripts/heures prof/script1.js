...
var query;
if (args.showDetail) {
    query = "select per.id, per.nom, per.prenom, plan.jour, plan.debut, plan.fin, sal.nom as salle, act.statut, act.niveau from prof prof " +
    ...
    "and act.cours != 0 " +
    "order by per.nom, per.prenom, plan.jour, plan.debut";
} else {
